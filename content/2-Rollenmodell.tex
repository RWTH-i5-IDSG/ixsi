...
\begin{figure*}[ht]
\centering
\includegraphics[width=0.9\textwidth]{role-model-crop.pdf}
...
\item Ein Kunde fragt über das FVS die Verfügbarkeit eines Fahrzeugs an.
\end{itemize}
