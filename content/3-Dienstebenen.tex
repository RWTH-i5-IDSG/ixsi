...
Dienst 8 dient dem Freischalten von Fahrzeugen bzw. Buchungszielen (ggfs. auch ein Schlüsselkasten) durch das RIS. Dies erlaubt die Öffnung bzw. Freischaltung das Fahrzeug innerhalb der Endanwenderanwendung des RIS, z.B. innerhalb einer mobilen App. Die Freischaltung bezieht sich immer auf eine vorausgegangene Buchung und eine Authentifizierung ist erforderlich.
