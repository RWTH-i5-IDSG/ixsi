...
\begin{figure}[h]
  ...
  \node[rectangleTX](s1) {Dienst 1};
  \node[rectangleTX, below left of=s1](s3) {Dienst 3};
  \node[rectangleTX, left of=s3](s2) {Dienst 2};
  \node[rectangleTX, below right of=s1](s4) {Dienst 4};
  \node[rectangleTX, right of=s4](s6) {Dienst 6};
  \node[rectangleTX, below of=s4](s5) {Dienst 5};
