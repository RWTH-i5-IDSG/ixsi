...
% Interaktionsprotokollbilder
\newcommand{\interactiongraphics}[1]{\begin{center}
\includegraphics[width=11cm]{graphics/#1.pdf}
\end{center}}
...
\newcommand*{\xmlexample}[1]{\begin{minipage}{\textwidth}\lstinputlisting[style=xml-style]{xml/examples/#1.xml}\end{minipage}}
